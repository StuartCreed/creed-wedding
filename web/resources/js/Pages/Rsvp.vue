    ...
    <MainLayout>
        ...
        <form class="grid grid-cols-1 gap-2" @submit.prevent="submit">
            <div class="py-2">
                ...
                <input id="coming" :value="true" name="rspv" type="radio" v-model="form.coming" class="p-2 m-2 rounded border border-black focus:outline-none hover:bg-green-500"/>
            </div>

            <div class="py-2">
                <label for="not-coming">I am not able to come</label>
                <input id="not-coming" :value="false" name="rspv" v-model="form.coming" type="radio" class="p-2 m-2 border border-black rounded focus:outline-none hover:bg-red-500"/>
            </div>
